...
text = text.replace('__version__ = "1.5.0"', '__version__ = "1.10.0"', 1)
...
OVERRIDES = r'''
# ===== Stable runtime 1.10: based on last non-crashing 1.5 UI path =====
...
print('Stable runtime 1.10 applied from 1.5 baseline')
